...
/* harmony import */ var _modules_scroll_to__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/scroll-to */ "./js/modules/scroll-to.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  _modules_header_menu__WEBPACK_IMPORTED_MODULE_2__["headerMenu"].classList.remove('main-navigation--no-js');
  _modules_header_menu__WEBPACK_IMPORTED_MODULE_2__["header"].classList.remove('main-header--no-js');
  if (_modules_header_menu__WEBPACK_IMPORTED_MODULE_2__["buttonOpen"]) {
    _modules_header_menu__WEBPACK_IMPORTED_MODULE_2__["buttonOpen"].addEventListener('click', _modules_header_menu__WEBPACK_IMPORTED_MODULE_2__["headerMenuHandler"]);
  }
  if (_modules_scroll_to__WEBPACK_IMPORTED_MODULE_3__["navigationLinks"].length > 0) {
    var _iterator = _createForOfIteratorHelper(_modules_scroll_to__WEBPACK_IMPORTED_MODULE_3__["navigationLinks"]),
      _step;
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        link.addEventListener('click', function (evt) {
          switch (evt.target.ariaLabel) {
            case 'features':
              Object(_modules_scroll_to__WEBPACK_IMPORTED_MODULE_3__["scrollHandler"])(evt, _modules_scroll_to__WEBPACK_IMPORTED_MODULE_3__["featuresSection"]);
              break;
            case 'products':
              Object(_modules_scroll_to__WEBPACK_IMPORTED_MODULE_3__["scrollHandler"])(evt, _modules_scroll_to__WEBPACK_IMPORTED_MODULE_3__["productsSection"]);
              break;
            case 'booking':
              Object(_modules_scroll_to__WEBPACK_IMPORTED_MODULE_3__["scrollHandler"])(evt, _modules_scroll_to__WEBPACK_IMPORTED_MODULE_3__["bookingSection"]);
              break;
            case 'contacts':
              Object(_modules_scroll_to__WEBPACK_IMPORTED_MODULE_3__["scrollHandler"])(evt, _modules_scroll_to__WEBPACK_IMPORTED_MODULE_3__["contactsSection"]);
              break;
          }
        });
      }
...
/*!***********************************!*\
  !*** ./js/modules/header-menu.js ***!
  \***********************************/
/*! exports provided: headerMenuHandler, buttonOpen, headerMenu, header */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "headerMenuHandler", function() { return headerMenuHandler; });
...
var headerMenu = document.querySelector('.main-navigation');
var buttonOpen = document.querySelector('.main-navigation__button');
var mainTitle = document.querySelector('.main-screen__container h2');
var mainDescription = document.querySelector('.main-screen__container p');
...
/*!*********************************!*\
  !*** ./js/modules/scroll-to.js ***!
  \*********************************/
/*! exports provided: navigationLinks, featuresSection, productsSection, bookingSection, contactsSection, scrollHandler */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "navigationLinks", function() { return navigationLinks; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "featuresSection", function() { return featuresSection; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "productsSection", function() { return productsSection; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "bookingSection", function() { return bookingSection; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "contactsSection", function() { return contactsSection; });
...
var scrollHandler = function scrollHandler(evt, section) {
  if (section) {
    evt.preventDefault();
